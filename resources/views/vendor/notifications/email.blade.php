                    ...
                    <td style="{{ $style['email-body'] }}" width="100%">
                        <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0"
                            ...
                            <tr>
                                ...
                                <!-- Salutation -->
                                    <p style="{{ $style['paragraph'] }}">
                                        Atenciosamente,<br>{{ config('app.club-name') }}
                                    </p>
                                            ...
                                            <tr>
                                                <td style="{{ $fontFamily }}">
                                                    <p style="{{ $style['paragraph-sub'] }}">
                                                        Se tiver problemas em clicar em "{{ $actionText }}",
                                                        copie e cole a seguinte URL no seu browser:
                                                    </p>
                                ...
                                <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}">
                                    <p style="{{ $style['paragraph-sub'] }}">
                                        ...
                                        <a style="{{ $style['anchor'] }}" href="{{ url('/') }}"
                                           target="_blank">{{ config('app.club-name') }}</a>.
